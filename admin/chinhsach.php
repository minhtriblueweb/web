...
if (isset($_GET['del'])) {
  $id = $_GET['del'];
  $del = $news->del_news($id, 'chinhsach');
}
if (isset($_GET['listid'])) {
  $listid = $_GET['listid'];
  $xoanhieu = $news->delete_multiple_news($listid, 'chinhsach');
}
$records_per_page = 10;
$current_page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$total_records = $functions->phantrang('tbl_news', 'chinhsach');
...
<section class="content">
  <div class="card-footer text-sm sticky-top">
    <a class="btn btn-sm bg-gradient-primary text-white" href="themchinhsach.php" title="Thêm mới"><i
            ...
            <?php if ($show_chinhsach): ?>
              <?php while ($resule = $show_chinhsach->fetch_assoc()): ?>
                <tr>
                  ...
                  <td class="align-middle">
                    <a href="suachinhsach.php?id=<?= $resule['id'] ?>" title="<?= $resule['namevi'] ?>">
                  ...
                  <td class="align-middle">
                    <a class="text-dark text-break" href="suachinhsach.php?id=<?= $resule['id'] ?>"
                    ...
                    <div class="tool-action mt-2 w-clear">
                      ...
                      <a class="text-info mr-3" href="suachinhsach.php?id=<?= $resule['id'] ?>"
                  ...
                  <td class="align-middle text-center text-md text-nowrap">
                    <a class="text-primary mr-2" href="suachinhsach.php?id=<?= $resule['id'] ?>" title="Chỉnh sửa"><i
