...
<!-- Main content -->
<?php
$show_social = $social->show_social();
if (isset($_GET['del'])) {
  $id = $_GET['del'];
  $del = $social->del_social($id);
}
if (isset($_GET['listid'])) {
  $listid = $_GET['listid'];
  $xoanhieu = $social->xoanhieu_social($listid);
}
?>
...
<section class="content">
  <div class="card-footer text-sm sticky-top">
    <a class="btn btn-sm bg-gradient-primary text-white" href="themsocial.php" title="Thêm mới"><i
    ...
    <div class="card-body table-responsive p-0">
      <table class="table table-hover">
        ...
        <tbody>
          <?php if ($show_social):
          ?>
            <?php while ($resule = $show_social->fetch_assoc()):
            ?>
              <tr>
                ...
                <td class="align-middle">
                  <input type="number" class="form-control form-control-mini m-auto update-numb" min="0"
                    value="<?= $resule['numb']; ?>" data-id="<?= $resule['id']; ?>" data-table="tbl_social">
                </td>
                <td class="align-middle">
                  <a href="themsocial.php?id=<?= $resule['id']; ?>" title="<?= $resule['name']; ?>">
                    <img
                ...
                <td class="align-middle">
                  <a class="text-dark text-break" href="themsocial.php?id=<?= $resule['id']; ?>"
                ...
                <td class="align-middle text-center">
                  <div class="custom-control custom-checkbox my-checkbox">
                    <input type="checkbox" class="custom-control-input show-checkbox"
                      id="show-checkbox-hienthi-<?= $resule['id']; ?>" data-table="tbl_social" data-type="hienthi"
                      data-id="<?= $resule['id']; ?>"
                ...
                <td class="align-middle text-center text-md text-nowrap">
                  <a class="text-primary mr-2" href="themsocial.php?id=<?= $resule['id']; ?>" title="Chỉnh sửa"><i
