...
<?php	
  ...
  $get_id = $slideshow -> get_id_slideshow($id);
  if($get_id){
    $result = $get_id -> fetch_assoc();
  }
	if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit'])) {
    $update = $slideshow -> update_slideshow($_POST,$_FILES,$id);
  }
?>
<!-- Main content -->
...
<section class="content">
  <form class="validation-form" novalidate="" method="post" action="" enctype="multipart/form-data">
    <div class="card-footer text-sm sticky-top">
      <button type="submit" class="btn btn-sm bg-gradient-primary submit-check " name="edit"><i
          ...
          <div class="upload-file">
            ...
            <div class="photoUpload-zone w-25">
              <div class="photoUpload-detail" id="photoUpload-preview">
                <a data-fancybox href=""><img class="rounded" src="<?php if(empty($result['file'])){
          ...
          <div class="form-group d-inline-block mb-2 mr-2">
            ...
            <div class="custom-control custom-checkbox d-inline-block align-middle">
              <input type="checkbox" class="custom-control-input hienthi-checkbox0" name="hienthi"
                id="hienthi-checkbox0" value="hienthi" <?php if($result['hienthi'] == 'hienthi'){ echo "checked" ; }
                    ?>>
