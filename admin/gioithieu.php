...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['upload'])) {
  $update = $trangtinh->update_static($_POST, 'gioithieu', $result_gioithieu['id']);
}
?>
...
<section class="content">
  <form class="validation-form" novalidate="" method="post" id="form-watermark" action="" enctype="multipart/form-data">
              ...
              <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control for-seo text-sm" name="namevi" id="namevi"
                    placeholder="Tiêu đề (vi)" value="<?= $result_gioithieu['namevi'] ?>" required>
                </div>
                <div class="form-group">
                  ...
                  <textarea class="form-control for-seo text-sm form-control-ckeditor" name="contentvi" id="contentvi"
                    placeholder="Nội dung (vi)"><?= $result_gioithieu['contentvi'] ?></textarea>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                      <div class="tab-pane fade show active" id="tabs-seolang-vi" role="tabpanel"
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control check-seo title-seo text-sm" name="titlevi"
                            id="titlevi" placeholder="SEO Title (vi)" value="<?= $result_gioithieu['titlevi'] ?>">
                        </div>
                        <div class="form-group">
                          <div class="label-seo">
                          ...
                          <input type="text" class="form-control check-seo keywords-seo text-sm" name="keywordsvi"
                            id="keywordsvi" placeholder="SEO Keywords (vi)"
                            value="<?= $result_gioithieu['keywordsvi'] ?>">
                        </div>
                        <div class="form-group">
                          <div class="label-seo">
                          ...
                          <textarea class="form-control check-seo description-seo text-sm" name="descriptionvi"
                            ...
                            placeholder="SEO Description (vi)"><?= $result_gioithieu['descriptionvi'] ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <input type="hidden" name="type" id="type" value="gioithieu">
  </form>
</section>
<!-- Main Footer -->
