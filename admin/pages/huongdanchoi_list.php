...
$total_pages = ceil($functions->phantrang('tbl_news', 'huongdanchoi') / $records_per_page);
...
$linkEdit = "index.php?page=huongdanchoi_form&id=";
$linkAdd = "index.php?page=huongdanchoi_form";
?>
<?php
$name = 'hướng dẫn chơi';
$breadcrumb = [
