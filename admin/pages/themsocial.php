...
if (isset($_GET['id']) && $_GET['id'] != NULL) {
  $id = $_GET['id'];
  $get_id = $social->get_id_social($id);
  if ($get_id) {
    $result = $get_id->fetch_assoc();
  }
  if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit'])) {
    $update = $social->update_social($_POST, $_FILES, $id);
  }
}
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add'])) {
  ...
  // print_r($data);
  // echo "</pre>";
  $insert = $social->insert_social($_POST, $_FILES);
}
?>
<!-- Main content -->
    ...
    <div class="row">
      <ol class="breadcrumb float-sm-left">
        ...
        <li class="breadcrumb-item active">
          <?php echo !empty($id) ? "Chỉnh sửa" : "Thêm mới"; ?> Social
        </li>
      </ol>
    </div>
  </div>
...
<section class="content">
  <form class="validation-form" novalidate method="post" action="" enctype="multipart/form-data">
    <div class="card-footer text-sm sticky-top">
      ...
      <a class="btn btn-sm bg-gradient-danger" href="social.php" title="Thoát"><i
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                  <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control for-seo text-sm" name="desc" id="desc" placeholder="Mô tả"
                        value="<?php echo $result['desc'] ?? ""; ?>">
                    </div>
                    <div class="form-group">
