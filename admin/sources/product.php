...
function deleteProduct(string $level)
{
  ...
  $redirect = "index.php?com=product&act=$act&type=$type";
...
function saveProduct(string $level)
{
  ...
  $linkMan  = "index.php?com=product&act=$act&type=$type";
  $linkForm = "index.php?com=product&act=form" . ($isMan ? '' : "_$level") . "&type=$type";
