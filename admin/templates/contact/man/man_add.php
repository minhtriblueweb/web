...
$linkSave = "index.php?com=contact&act=save&type=" . $type;
?>
<!-- Content Header -->
        ...
        <div class="row">
          <div class="form-group col-12">
            ...
            <?php if (isset($item['file_attach']) && ($item['file_attach'] != '')) { ?>
              <a class="btn btn-sm bg-gradient-primary text-white d-inline-block align-middle p-2 rounded mb-1" href="<?= @$item['file_attach'] ?>" title="<?= downloadtaptinhientai ?>"><i class="fas fa-download mr-2"></i><?= downloadtaptinhientai ?></a>
            <?php } else { ?>
