  ...
  <div class="container-fluid">
    <div class="row">
      <ol class="breadcrumb float-sm-left">
        ...
        <li class="breadcrumb-item active"><?= ($id > 0 ? capnhat : themmoi) . ' ' . ($config['product'][$type]['title_main_list'] ?? '') ?></li>
      </ol>
    </div>
  </div>
</section>
                ...
                <div class="tab-content" id="custom-tabs-article-tabContent-lang">
                  <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                    <div class="tab-pane fade show <?= ($k == $lang) ? 'active' : '' ?>"
                      ...
                      <!-- Mô tả -->
                      <?php if (!empty($config['product'][$type]['desc_cke_list']) || !empty($config['product'][$type]['desc_list'])): ?>
                        <div class="form-group">
                      ...
                      <!-- Nội dung -->
                      <?php if (!empty($config['product'][$type]['content_cke_list']) || !empty($config['product'][$type]['content_list'])): ?>
                        <div class="form-group">
