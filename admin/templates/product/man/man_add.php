            ...
            <div class="card-body">
              <div class="form-group-category row">
                <?php if (isset($config['product'][$type]['dropdown']) && $config['product'][$type]['dropdown'] == true) { ?>
                  ...
                  <?php } ?>
                  <?php if (isset($config['product'][$type]['vari']) && $config['product'][$type]['vari'] == true) { ?>
                    <div class="form-group col-xl-6 col-sm-4">
                      <label class="d-block" for="id_vari">Danh mục cấp 5:</label>
                      <?= $func->getAjaxCategory('product', 'vari', $type) ?>
                    </div>
                  <?php } ?>
                <?php } ?>
                <?php if (isset($config['product'][$type]['brand']) && $config['product'][$type]['brand'] == true) { ?>
                  <div class="form-group col-xl-6 col-sm-4">
                    <label class="d-block" for="id_brand">Hãng sản phẩm:</label>
                    <?= $func->getAjaxCategory('product', 'brand', $type, 'Hãng sản phẩm') ?>
                  </div>
                <?php } ?>
        ...
        <div class="card card-primary card-outline text-sm">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <?php } ?>
              <?php if (isset($config['product'][$type]['capacity']) && $config['product'][$type]['capacity'] == true) { ?>
                <div class="form-group col-md-12">
                  <label class="d-block" for="capacity">Dung tích:</label>
                  <input type="text" class="form-control text-sm" name="data[capacity]" id="capacity" placeholder="Dung tích" value="<?= (!empty($flash->has('capacity'))) ? $flash->get('capacity') : @$item['capacity'] ?>">
                </div>
              <?php } ?>
            ...
            <div class="form-group">
              ...
              if (!empty($config['product'][$type]['check'])) {
