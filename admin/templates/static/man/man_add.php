                ...
                <div class="upload-file mb-2">
                  ...
                  <?php if (isset($item['file_attach']) && $item['file_attach'] != '') { ?>
                    <div class="file-uploaded mb-2">
                      <a class="btn btn-sm bg-gradient-primary text-white d-inline-block align-middle rounded p-2" href="<?= UPLOAD . @$item['file_attach'] ?>" title="<?= downloadtaptinhientai ?>"><i class="fas fa-download mr-2"></i><?= downloadtaptinhientai ?></a>
                    </div>
                  <?php } ?>
                      ...
                      <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                        <?php if (isset($config['static'][$type]['name']) && $config['static'][$type]['name'] == true) { ?>
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control for-seo text-sm" name="data[name<?= $k ?>]" id="name<?= $k ?>" placeholder="<?= tieude ?> (<?= $k ?>)" value="<?= (!empty($flash->has('name' . $k))) ? $flash->get('name' . $k) : @$item['name' . $k] ?>"
                              <?= ($k == $lang) ? 'required' : '' ?>>
                          </div>
                        <?php } ?>
          ...
          <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
              <div class="show-video">
                <video controls>
                  <source src="<?= UPLOAD . $item['video'] ?>" id="video_here">
