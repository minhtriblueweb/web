...
<HEAD>
  ...
  <base href="<?= BASE_ADMIN ?>" />
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta http-equiv="REFRESH" content="3; url=<?= BASE_ADMIN . $page_transfer ?>">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no">
  <meta name="robots" content="noodp,noindex,nofollow" />
  <link rel="stylesheet" href="<?= BASE ?>assets/bootstrap/bootstrap.css">
...
<BODY>
  <div id="alert">
    ...
    <div class="rlink">(<a href="<?= BASE_ADMIN . $page_transfer ?>">Click vào đây nếu không muốn đợi lâu</a>)</div>
    <div class="progress">
  ...
  <script type="text/javascript">
    ...
    if (meta) {
      ...
      var seconds = parseFloat(content.split(';')[0].trim());
