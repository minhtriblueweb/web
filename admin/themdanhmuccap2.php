  ...
  <div class="container-fluid">
    <div class="row">
      <ol class="breadcrumb float-sm-left">
        ...
        <li class="breadcrumb-item active">Thêm mới danh mục cấp 2</li>
      </ol>
    </div>
  </div>
</section>
                  ...
                  <div class="tab-pane fade show active" id="tabs-sluglang-vi" role="tabpanel"
                    ...
                    <div class="form-gourp mb-0">
                      ...
                      <input type="text" class="form-control slug-input no-validate text-sm" name="slugvi" id="slugvi"
                        placeholder="Đường dẫn (vi)" required value="<?php if(!empty($slugvi)){ echo $slugvi ;} ?>" />
                ...
                <?php 
                  if($show_danhmuc) {
                    ...
                    while($resule = $show_danhmuc -> fetch_assoc()){
                      $i++;
                ?>
                <option value="<?php echo $resule['id'] ; ?>">
                  <?php echo $resule['namevi'] ; ?>
                </option>
                <?php } } ?>
              </select>
            </div>
