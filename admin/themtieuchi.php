...
if (isset($_GET['id']) && $_GET['id'] != NULL) {
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit'])) {
    $update = $tieuchi->update_tieuchi($_POST, $_FILES, $id);
  }
}
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add'])) {
  ...
  // print_r($data);
  // echo "</pre>";
  $insert = $tieuchi->insert_tieuchi($_POST, $_FILES);
}
?>
<!-- Main content -->
    ...
    <div class="row">
      <ol class="breadcrumb float-sm-left">
        ...
        <li class="breadcrumb-item active">
          <?php echo !empty($id) ? "Chỉnh sửa" : "Thêm mới"; ?> Tiêu chí
        </li>
      </ol>
    </div>
  </div>
...
<section class="content">
  <form class="validation-form" novalidate method="post" action="" enctype="multipart/form-data">
    <div class="card-footer text-sm sticky-top">
      ...
      <a class="btn btn-sm bg-gradient-danger" href="tieuchi.php" title="Thoát"><i
