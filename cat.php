    ...
    if ($kg_danhmuc_c2) {
      ...
      if ($get_name_danhmuc !== false) {
        ...
        if ($kg_danhmuc) {
          ...
          $get_sp = $sanpham->show_sanpham_pagination($records_per_page, $current_page, 'hienthi', '', $id_cat, '');
...
<div class="wrap-main wrap-home w-clear">
  ...
  <div class="wrap-main wrap-template w-clear" style="margin: 0 auto !important;">
    <div class="content-main">
      ...
      <?php endif ?>
      <div class="mt-3">
        <?= $pagination_html = $functions->renderPagination_tc($current_page, $total_pages, BASE . 'cate/' . $kg_danhmuc_c2['slugvi'] . '/page-');
        ?>
      </div>
    </div>
  </div>
