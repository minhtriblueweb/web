...
$config['product'][$nametype]['check'] = array("hienthi" => "Hiển thị", "noibat" => "Nổi bật", "banchay" => "Bán chạy",);
...
$config['product'][$nametype]['width'] = 500;
$config['product'][$nametype]['height'] = 500;
