...
$config['product'][$type]['desc_cat'] = false;
...
$config['product'][$type]['width_item'] = $config['size-img'][$type]['item']['width'] = 300;
$config['product'][$type]['height_item'] = $config['size-img'][$type]['item']['height'] = 200;
