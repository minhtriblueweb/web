<div class="floating-support" data-aos="fade-left" data-aos-anchor="#example-anchor" data-aos-offset="500" data-aos-duration="500">
    ...
    <?php while ($result_social = $show_social->fetch_assoc()): ?>
      <a href="<?= $result_social['link'] ?>" class="floating-support__item" target="_blank">
        <div class="floating-support__item__icon">
          <img src="<?= BASE_ADMIN . UPLOADS . $result_social['file'] ?>" alt="<?= $result_social['name'] ?>" class="tada">
        </div>
