...
class PDODb
{
    ...
    public function checkPHPVersion(){
        $version = (int) PHP_VERSION_ID;
        // echo "Current PHP version: " . PHP_VERSION . " (PHP_VERSION_ID: $version)";
        if ($version < 80209) {
            if (!headers_sent()) {
                header('HTTP/1.1 500 Internal Server Error');
            }
            $err = 'PHP version not supported < 8.2.9 and you are running '.PHP_VERSION;
