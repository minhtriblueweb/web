...
$config['product'][$type]['import'] = true;
$config['product'][$type]['export'] = true;
...
$config['product'][$type]['images_item'] = false;
...
$config['product'][$type]['images_sub'] = false;
$config['product'][$type]['show_images_sub'] = false;
$config['product'][$type]['slug_sub'] = true;
$config['product'][$type]['check_sub'] = array("hienthi" => "Hiển thị");
