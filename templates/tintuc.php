<?php
$show_tintuc = $functions->show_data([
  'table' => 'tbl_news',
        ...
        <?php while ($row_tintuc = $show_tintuc->fetch_assoc()): ?>
          <div>
            <div class="item-service">
              <div class="images">
                <a class="scale-img hover-glass text-decoration-none" href="<?= $row_tintuc['slug'] ?>" title="<?= $row_tintuc['name'] ?>">
                  <img class="w-100"
              ...
              <div class="content">
                <h3>
                  <a class="text-split" href="<?= $row_tintuc['slug'] ?>"><?= $row_tintuc['name'] ?></a>
                </h3>
              </div>
            </div>
          </div>
